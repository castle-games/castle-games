...
};function isObject$3(type, value) {
...
var Range = function (_Record) {
  ...
  createClass(Range, [{
    ...
    value: function isRange(value) {
      return isObject$3('range', value) || Decoration.isDecoration(value) || Selection.isSelection(value);
    }
  }]);
  return Range;
...
function create$2(type) {
  ...
  ObjectInterface[is] = isObject$3.bind(null, type);
...
mixin(ModelInterface, [Block, Change, Decoration, Document, History, Inline, Leaf, Mark, Node, Operation, Point, Range, Schema, Selection, Stack$2, Text, Value]);
