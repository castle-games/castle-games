...
const run = async () => {
  ...
  const featuredPlaylist2 = await Actions.getPlaylist({ playlistId: 'playlist:jasons-favorites' });
  ...
  const state = {
    ...
    featuredPlaylists: [featuredPlaylist1],
    featuredMedia: [...featuredPlaylist2.mediaItems],
