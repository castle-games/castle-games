...
const char *kGhostLoadEndEventName = "nativeLoadEnd";
const char *kGhostLoadErrorEventName = "nativeLoadError";
const char *kGhostNativeMenuSelectedEventName = "nativeMenuSelected";
